...
var icons = {
  animal: {
    ...
    coords: [1, 1, 1, 110, 75, 110, 75, 1],
    type: 'poly'
  },
  hangwoman: {
    icon: 'images/hangwoman-short.png',
    coords: [1, 1, 1, 100, 87, 100, 87, 1],
    type: 'poly'
  },
  cat: {
    icon: 'images/cat.png',
    coords: [1, 1, 1, 75, 82, 75, 82, 1],
    type: 'poly'
  },
  cat1: {
    icon: 'images/cat1.png',
    coords: [1, 1, 1, 60, 86, 60, 86, 1],
    type: 'poly'
  },
  witchOverHouse: {
    icon: 'images/witch-over-house.png',
    coords: [1, 1, 1, 50, 123, 50, 123, 1],
    type: 'poly'
  },
  vtCat: {
    icon: 'images/vt-cat.png',
    coords: [1, 1, 1, 70, 100, 70, 100, 1],
    type: 'poly'
  },
  witch: {
    icon: 'images/witch.png',
    coords: [1, 1, 1, 88, 100, 88, 100, 1],
    type: 'poly'
  },
  witch1: {
    icon: 'images/witch-1.png',
    coords: [1, 1, 1, 64, 100, 64, 100, 1],
    type: 'poly'
  }
};
...
var coordinates = [
  ['Würzburg', 49.792017, 9.950237, 4, 'hangwoman',
            '<div class="content">'+
            ...
            '</div>'+
            '</div>'],
  ['Berlin', 52.520050, 13.404871, 3, 'cat',
            '<div class="content">'+
            '<div class="site-notice">'+
            '</div>'+
            ...
            '</div>'+
            '</div>'],
  ['Speyer', 49.316830, 8.439153, 5, 'cat1',
            '<div class="content">'+
            '<div class="site-notice">'+
            '</div>'+
            ...
            '</div>'+
            '</div>'],
  ['Rome', 41.902671, 12.496252, 2, 'witch',
            '<div class="content">'+
            '<div class="site-notice">'+
            '</div>'+
            ...
            '</div>'+
            '</div>'],
  ['Lancashire', 53.850536, -2.668760, 1, 'witch1',
            '<div class="content">'+
            '<div class="site-notice">'+
            '</div>'+
            ...
            '</div>'+
            '</div>'],
  ['London', 51.507356, -0.127764, 1, 'vtCat',
            '<div class="content">'+
            '<div class="site-notice">'+
            '</div>'+
            ...
            '</div>'+
            '</div>'],
  ['Valais', 46.163517, 7.517275, 1, 'animal',
            '<div class="content">'+
            '<div class="site-notice">'+
            '</div>'+
            ...
            '</div>'+
            '</div>'],
  ['Paris', 48.857482, 2.349461, 1, 'witchOverHouse',
            '<div class="content">'+
            '<div class="site-notice">'+
            '</div>'+
...
function setMarkers(map) {
  ...
  for (var i = 0; i < coordinates.length; i++) {
    ...
    var marker = new google.maps.Marker({
      ...
      map: map,
      icon: icons[mark[4]].icon,
      shape: icons[mark[4]].shape,
      title: mark[0],
      zIndex: mark[3],
      html: mark[5]
    });
