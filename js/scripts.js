...
var coordinates = [
  ...
  ['Berlin', 52.520050, 13.404871, 3, 'cat',
            ...
            '</div>'+
            '</div>'],
  ['Speyer', 49.316830, 8.439153, 5, 'hangwoman',
            '<div class="content">'+
            '<div class="site-notice">'+
            '</div>'+
            ...
            '</div>'+
            '</div>'],
  ['Rome', 41.902671, 12.496252, 2, 'cat',
            '<div class="content">'+
            '<div class="site-notice">'+
            '</div>'+
            ...
            '</div>'+
            '</div>'],
  ['Lancashire', 53.850536, -2.668760, 1, 'hangwoman',
            '<div class="content">'+
            '<div class="site-notice">'+
            '</div>'+
            ...
            '</div>'+
            '</div>'],
  ['London', 51.507356, -0.127764, 1, 'hangwoman',
            '<div class="content">'+
            '<div class="site-notice">'+
            '</div>'+
            ...
            '</div>'+
            '</div>'],
  ['Valais', 46.163517, 7.517275, 1, 'hangwoman',
            '<div class="content">'+
            '<div class="site-notice">'+
            '</div>'+
            ...
            '</div>'+
            '</div>'],
  ['Paris', 48.857482, 2.349461, 1, 'cat',
            '<div class="content">'+
            '<div class="site-notice">'+
            '</div>'+
