...
var coordinates = [
  ['Würzburg', 49.792017, 9.950237, 4, '<div id="content">'+
            '<div id="siteNotice">'+
            '</div>'+
            '<h1 id="firstHeading" class="firstHeading">Würzburg Witch Trials</h1>'+
            '<div id="bodyContent">'+
            ...
            '</div>'+
            '</div>'],
  ['Berlin', 52.520050, 13.404871, 5, '<div id="content">'+
            '<div id="siteNotice">'+
            '</div>'+
            '<h1 id="firstHeading" class="firstHeading">Alternative für Deutschland</h1>'+
            '<div id="bodyContent">'+
            ...
            '</div>'+
            '</div>'],
  ['Speyer', 49.316830, 8.439153, 3, '<div id="content">'+
            '<div id="siteNotice">'+
            '</div>'+
            '<h1 id="firstHeading" class="firstHeading">Publication of <em>Malleus Maleifcarum</em></h1>'+
            '<div id="bodyContent">'+
            ...
            '</div>'+
            '</div>'],
  ['Rome', 41.902671, 12.496252, 2, '<div id="content">'+
            '<div id="siteNotice">'+
            '</div>'+
            '<h1 id="firstHeading" class="firstHeading">Italy\'s Fertility Day</h1>'+
            '<div id="bodyContent">'+
            ...
            '</div>'+
            '</div>'],
  ['Lancashire', 53.850536, -2.668760, 1, '<div id="content">'+
            '<div id="siteNotice">'+
            '</div>'+
            '<h1 id="firstHeading" class="firstHeading">Pendle Witches</h1>'+
            '<div id="bodyContent">'+
            ...
            '</div>'+
            '</div>'],
  ['London', 51.507356, -0.127764, 1, '<div id="content">'+
            '<div id="siteNotice">'+
            '</div>'+
            '<h1 id="firstHeading" class="firstHeading">Heels Lawsuit</h1>'+
            '<div id="bodyContent">'+
            ...
            '</div>'+
            '</div>'],
  ['Valais', 46.163517, 7.517275, 1, '<div id="content">'+
            '<div id="siteNotice">'+
            '</div>'+
            '<h1 id="firstHeading" class="firstHeading">Valais Witch Trials</h1>'+
            '<div id="bodyContent">'+
            ...
            '</div>'+
            '</div>'],
  ['Paris', 48.857482, 2.349461, 1, '<div id="content">'+
            '<div id="siteNotice">'+
            '</div>'+
            '<h1 id="firstHeading" class="firstHeading">Islamic Headscarf Ban</h1>'+
            '<div id="bodyContent">'+
