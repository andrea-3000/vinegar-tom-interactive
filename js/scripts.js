...
var coordinates = [
  ...
  ['Berlin', 52.520050, 13.404871, 3, 'cat',
            ...
            '</div>'+
            '</div>'],
  ['Speyer', 49.316830, 8.439153, 5, 'vtCat',
            '<div class="content">'+
            '<div class="site-notice">'+
            '</div>'+
  ...
  ['Lancashire', 53.850536, -2.668760, 1, 'witch1',
            ...
            '</div>'+
            '</div>'],
  ['London', 51.507356, -0.127764, 1, 'animal',
            '<div class="content">'+
            '<div class="site-notice">'+
            '</div>'+
            ...
            '</div>'+
            '</div>'],
  ['Valais', 46.163517, 7.517275, 1, 'cat1',
            '<div class="content">'+
            '<div class="site-notice">'+
            '</div>'+
            ...
            '</div>'+
            '</div>'],
  ['Paris', 48.857482, 2.349461, 1, 'cat3',
            '<div class="content">'+
            '<div class="site-notice">'+
            '</div>'+
